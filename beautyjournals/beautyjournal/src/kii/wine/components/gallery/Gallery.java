...
package kii.wine.components.gallery;
...
public class Gallery extends AbsSpinner implements
    ...
    public Gallery(Context context, AttributeSet attrs, int defStyle) {
        ...
        // mMinimumVelocity = configuration.getScaledMinimumFlingVelocity() * 8;
    ...
    int getLimitedMotionScrollAmount(boolean motionToLeft, int deltaX) {
        ...
        int galleryCenter = getCenterOfGallery(extremeChild);
        // Log.e("extremeChildCenter,galleryLeftmost", extremeChildCenter + ","
        // + galleryLeftmost);
        if (motionToLeft) {
        ...
        // int centerDifference = extremeChildCenter - galleryLeftmost;
    ...
    private int getCenterOfGallery(View view) {
        int paddingLeft = getPaddingLeft();
        return paddingLeft + view.getWidth() / 2;
    }
    ...
    private void scrollIntoSlots() {
        ...
        int targetCenter = getCenterOfGallery(mSelectedChild);

        int scrollAmount = targetCenter - selectedCenter;
        // Log.e("scrollamount", scrollAmount + "");
        if (scrollAmount != 0) {
            mFlingRunnable.startUsingDistance(scrollAmount);
        } else {
            onFinishedMovement();
            if (mListener != null) {
                mListener.onScroll(this, this.mFirstPosition, getChildCount(),
                        mItemCount);
                mListener.onScrollStateChanged(this,
    ...
    private void setSelectionToCenterChild() {
        ...
        int galleryCenter = getCenterOfGallery(selView);
    ...
    void layout(int delta, boolean animate) {
        ...
        int selectedOffset = childrenLeft + (sel.getWidth() / 2)
                - (sel.getWidth() / 2);
    ...
    private void fillToGalleryLeft() {
        ...
        if (prevIterationView != null) {
            ...
            curPosition = 0;
            curRightEdge = right - left - paddingRight;
    ...
    private void fillToGalleryRight() {
        ...
        // int paddingBottom = getPaddingBottom();
        int itemSpacing = mSpacing;
        int galleryRight = right - left - paddingRight;
        int numChildren = getChildCount();
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
        ...
        velocityX = Math.min(mMinimumVelocity * 10, (int) Math.abs(velocityX));
        velocityX *= direction;
    ...
    private boolean scrollToChild(int childPosition) {
        ...
        if (child != null) {
            int distance = getCenterOfGallery(child) - getCenterOfView(child);
    ...
    private class FlingRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (delta > 0) {
                ...
                delta = Math.min(getWidth() - paddingLeft - paddingRight - 1,
                        delta);
            } else {
                ...
                // Don't fling more than 1 screen
                delta = Math.max(
                        -(getWidth() - paddingRight - paddingLeft - 1), delta);
            }
    ...
    public interface OnScrollListener {
        ...
        public void onScroll(AdapterView<SpinnerAdapter> view,
                int firstVisibleItem, int visibleItemCount, int totalItemCount);

        public void onScrollStateChanged(AdapterView<SpinnerAdapter> view,
                int scrollState);
    }
}
