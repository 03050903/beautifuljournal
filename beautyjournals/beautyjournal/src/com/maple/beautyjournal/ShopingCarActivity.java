...
public class ShopingCarActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        context = ShopingCarActivity.this;
        LayoutInflater inflater=LayoutInflater.from(context);
        View v = inflater.inflate(R.layout.activity_shopping_car, null, false);
        ...
        quick_go.setOnClickListener(new View.OnClickListener() {
            ...
            buyMinus.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(product.count>1){
                        product.count--;
                        count.setText(""+product.count);
                        ShopingCarActivity.this.setPriceAndCount();
                    }
                }
            });
