...
public class FindPassWordActivity extends BaseActivity{
        ...
        this.mGetWord.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(TextUtils.isEmpty(phoneNum)){
					Toast.makeText(FindPassWordActivity.this, "请输入电话号码", Toast.LENGTH_SHORT).show();
					return;
				}
	...
	class reqMessageCodeTask extends AsyncTask<Object, Object, AccessorResultWrapper>{
		...
		protected AccessorResultWrapper doInBackground(Object... arg0) {
			AccessorResultWrapper result = MessageCodeAccessor.getMsgCode(FindPassWordActivity.this,MsgCodeTypeEnum.TypeFindPassword, phoneNum);
			return result;
		}
		...
		protected void onPostExecute(AccessorResultWrapper result){
			...
			if(!result.isSuccess){
				Toast.makeText(FindPassWordActivity.this, result.errorMsg, Toast.LENGTH_SHORT).show();
				timeCount.cancel();
	...
	class checkMessageCodeTask extends AsyncTask<Object, Integer, AccessorResultWrapper>{
		...
		@Override
		protected AccessorResultWrapper doInBackground(Object... arg0) {
			AccessorResultWrapper message = MessageCodeAccessor.verifyMsgCode(FindPassWordActivity.this,phoneNum,checkWord );
		...
		protected void onPostExecute(AccessorResultWrapper result){
	        ...
	        Intent intent = new Intent(FindPassWordActivity.this, SetNewPassWordActivity.class);
