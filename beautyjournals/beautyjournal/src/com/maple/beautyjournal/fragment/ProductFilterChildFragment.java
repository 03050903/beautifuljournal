...
public class ProductFilterChildFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.product_filter_child2, container, false);
        initList2(v);
        initQuery();
        return v;
    }
    ...
    private void initList2(View parent) {
        ...
        list2.setOnChildClickListener(new OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition,
                ...
                ProductFilterFragment.fromChild = "back_again";
            	ProductFilterChildFragment.this.getActivity().onBackPressed();
                return false;
            }
    ...
    public class List2Adapter extends BaseExpandableListAdapter {
        ...
        public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView,
            ...
            LinearLayout layout = (LinearLayout) LayoutInflater.from(getActivity())
                    .inflate(R.layout.product_filter_child, null);
