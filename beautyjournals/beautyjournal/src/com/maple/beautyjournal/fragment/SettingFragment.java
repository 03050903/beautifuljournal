    ...
    private void initViews(View v) {
        ...
        address.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                FragmentManager fm = SettingFragment.this.getActivity().getSupportFragmentManager();
                FragmentTransaction ft = fm.beginTransaction();

                Fragment address_manager = Fragment
                        .instantiate(SettingFragment.this.getActivity(), AddressListFragment.class.getName(), null);
        ...
        genderView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
