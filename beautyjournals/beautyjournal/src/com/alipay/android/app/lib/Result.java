...
public class Result {
	...
	public boolean IsSuccessOrOnProcess() {
		//TODO(shuyinghuang) isSignOk should be true but now it's false
		return (this.mIsSuccess || this.mIsOnProcess);
	}
	...
	public  void parseResult() {
		try {
			...
			this.mIsSuccess = "9000".equals(rs);
			this.mIsOnProcess ="8000".equals(rs);
